 ...
 * @author Aaron
 */
public class FemaleNpcClerk extends Npc {
    
    private boolean walking;
    public int menuNum;
    
        public FemaleNpcClerk(int x, int y) {
            super(x, y);
        }
        
        public FemaleNpcClerk(int x, int y, String path) {
            super(x, y, path);
        }
        
        public FemaleNpcClerk(int x, int y, int menuNum) {
            super(x, y, menuNum);
        }
        
        public FemaleNpcClerk(int x, int y, int menuNum, String path) {
            super(x, y, menuNum, path);
        }
